...
// 	wp_enqueue_script( 'hello-world-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

// 	wp_enqueue_script( 'hello-world-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
function helloworld_assets () {
	$base_uri = get_template_directory_uri() . '/dist';

	wp_enqueue_style( 'helloworld-style', $base_uri . '/bundle.css', array(), '1.0.0', 'all' );

	wp_enqueue_script( 'jquery' );
	wp_enqueue_script( 'helloworld-script', $base_uri . '/bundle.js', array( 'jquery' ), '1.0.0', true );
}

add_action('wp_enqueue_scripts', 'helloworld_assets');
/**
